...
const deleteEntriesByAccount = `-- name: DeleteEntriesByAccount :exec
DELETE FROM entries WHERE account_id = $1
`

func (q *Queries) DeleteEntriesByAccount(ctx context.Context, accountID int64) error {
	_, err := q.db.ExecContext(ctx, deleteEntriesByAccount, accountID)
	return err
}
